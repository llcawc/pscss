!(function () {
  ...
  window.addEventListener('DOMContentLoaded', function () {
    ...
    const o = a()
    e(o)
    const n = document.querySelector('.color-switcher')
    ;(n
      ? (l(n, o),
        n.addEventListener('click', () => {
          const t =
            'light' === (n.firstElementChild?.attributes.getNamedItem('data-mode')?.value ?? a()) ? 'dark' : 'light'
          ;(e(t),
            l(n, t),
            ((t) => {
      ...
      t.addEventListener('change', () => {
        ;(localStorage.removeItem('theme'), e(a()))
      }))
  })
})()
